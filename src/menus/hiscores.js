...
const menu_hiscores = {
  ...
  drawMedals: () => {
    ...
    if (hiscores[1]) ctx.drawImage(sprites.medal_silver, menu_hiscores.silverMedal.pos.x, menu_hiscores.silverMedal.pos.y);
    if (hiscores[2]) ctx.drawImage(sprites.medal_bronze, menu_hiscores.bronzeMedal.pos.x, menu_hiscores.bronzeMedal.pos.y);
  },
  drawScore: (score, i) => {
